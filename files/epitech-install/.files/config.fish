...
alias ne="emacs -nw"
alias mr_clean="sh ~/my_scripts/mr_clean"
alias repo="sh ~/my_scripts/prepare_my_repo.sh $1"
alias normes="ruby ~/my_scripts/NormEZ.rb"
alias l="ls"
alias ll="ls -l"
alias right="bash ~/my_scripts/right.sh $1"
alias csp="bash ~/my_scripts/connect.sh"